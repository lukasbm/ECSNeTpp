...
namespace ecsnetpp
{
    ...
    Register_Class(Ack)
        ...
        Ack::Ack(const char *name, short kind) : ::omnetpp::cPacket(name, kind)
    {
        this->ackedMessageId = 0;
    }

    Ack::Ack(const Ack &other) : ::omnetpp::cPacket(other)
    {
        copy(other);
    }
    ...
    {
        this->ackedMessageId = other.ackedMessageId;
    ...
    void Ack::parsimPack(omnetpp::cCommBuffer *b) const
    {
        ...
        doParsimPacking(b, this->ackedMessageId);
    ...
    void Ack::parsimUnpack(omnetpp::cCommBuffer *b)
    {
        ...
        doParsimUnpacking(b, this->ackedMessageId);
        doParsimUnpacking(b, this->sender);
    }

    int Ack::getAckedMessageId() const
    {
        return this->ackedMessageId;
    }

    void Ack::setAckedMessageId(int ackedMessageId)
    {
    ...
    int AckDescriptor::findField(const char *fieldName) const
    {
        ...
        if (fieldName[0] == 'a' && strcmp(fieldName, "ackedMessageId") == 0)
            return base + 0;
    ...
    std::string AckDescriptor::getFieldValueAsString(void *object, int field, int i) const
    {
        ...
        {
        case 0:
            return long2string(pp->getAckedMessageId());
        case 1:
    ...
    bool AckDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
    {
        ...
        {
        case 0:
            pp->setAckedMessageId(string2long(value));
            return true;
        case 1:
            pp->setSender((value));
            return true;
