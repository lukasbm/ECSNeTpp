...
namespace ecsnetpp
{
    ...
    int StreamingMessageDescriptor::findField(const char *fieldName) const
    {
        ...
        if (fieldName[0] == 'm' && strcmp(fieldName, "messageId") == 0)
            return base + 0;
        if (fieldName[0] == 's' && strcmp(fieldName, "sender") == 0)
            return base + 1;
        if (fieldName[0] == 'c' && strcmp(fieldName, "content") == 0)
            return base + 2;
        if (fieldName[0] == 'i' && strcmp(fieldName, "isProcessingDelayInCyclesPerEvent") == 0)
            return base + 3;
        if (fieldName[0] == 'p' && strcmp(fieldName, "processingDelayPerEvent") == 0)
            return base + 4;
        if (fieldName[0] == 's' && strcmp(fieldName, "selectivityRatio") == 0)
            return base + 5;
        if (fieldName[0] == 's' && strcmp(fieldName, "startTime") == 0)
            return base + 6;
        if (fieldName[0] == 'o' && strcmp(fieldName, "operatorIngressTime") == 0)
            return base + 7;
        if (fieldName[0] == 'c' && strcmp(fieldName, "channelIngressTime") == 0)
            return base + 8;
        if (fieldName[0] == 'n' && strcmp(fieldName, "networkDelay") == 0)
            return base + 9;
        if (fieldName[0] == 'p' && strcmp(fieldName, "processingDelay") == 0)
            return base + 10;
        if (fieldName[0] == 'e' && strcmp(fieldName, "edgeProcessingDelay") == 0)
            return base + 11;
    ...
    int StreamingMessageDescriptor::getFieldArraySize(void *object, int field) const
    {
        ...
        StreamingMessage *pp = (StreamingMessage *)object;
        (void)pp;
        switch (field)
        {
        default:
    ...
    std::string StreamingMessageDescriptor::getFieldValueAsString(void *object, int field, int i) const
    {
        ...
        {
        case 0:
            return long2string(pp->getMessageId());
        case 1:
            return oppstring2string(pp->getSender());
        case 2:
            return oppstring2string(pp->getContent());
        case 3:
            return bool2string(pp->getIsProcessingDelayInCyclesPerEvent());
        case 4:
            return double2string(pp->getProcessingDelayPerEvent());
        case 5:
            return double2string(pp->getSelectivityRatio());
        case 6:
            return simtime2string(pp->getStartTime());
        case 7:
            return simtime2string(pp->getOperatorIngressTime());
        case 8:
            return simtime2string(pp->getChannelIngressTime());
        case 9:
            return double2string(pp->getNetworkDelay());
        case 10:
            return double2string(pp->getProcessingDelay());
        case 11:
            return double2string(pp->getEdgeProcessingDelay());
        default:
            return "";
        }
    }
    ...
    bool StreamingMessageDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
    {
        ...
        {
        case 0:
            pp->setMessageId(string2long(value));
            return true;
        case 1:
            pp->setSender((value));
            return true;
        case 2:
            ...
            return true;
        case 3:
            pp->setIsProcessingDelayInCyclesPerEvent(string2bool(value));
            return true;
        case 4:
            pp->setProcessingDelayPerEvent(string2double(value));
            return true;
        case 5:
            pp->setSelectivityRatio(string2double(value));
            return true;
        case 6:
            pp->setStartTime(string2simtime(value));
            return true;
        case 7:
            pp->setOperatorIngressTime(string2simtime(value));
            return true;
        case 8:
            pp->setChannelIngressTime(string2simtime(value));
            return true;
        case 9:
            pp->setNetworkDelay(string2double(value));
            return true;
        case 10:
            pp->setProcessingDelay(string2double(value));
            return true;
        case 11:
            pp->setEdgeProcessingDelay(string2double(value));
            return true;
        default:
            return false;
        }
